        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="fact-item text-center bg-light h-100 p-5 pt-0">
                    ...
                    <h3 class="mb-3">Établissement Public National</h3>
                    <p class="mb-0">Établissement public à caractère industriel et commercial (EPIC), doté de la personnalité morale et de l'autonomie financière.</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Maîtrise d'Œuvre & Recherche Appliquée</h3>
                        <p class="mb-4">Réalisation d'études urbaines, élaboration des plans d'urbanisme et définition des normes techniques nécessaires à l'aménagement du territoire.</p>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Assistance à Maîtrise d'Ouvrage Publique</h3>
                        <p class="mb-4">Accompagnement de l'État et des collectivités locales dans la préparation, la conduite et le suivi des projets urbains et territoriaux.</p>
                        <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Maîtrise d'Ouvrage Déléguée</h3>
                        <p class="mb-4">Gestion, pour le compte de l'État et des collectivités locales, de projets d'intervention et de réhabilitation des tissus urbains.</p>
                        <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Activité de Soutien</h3>
                        <p class="mb-4">Développement d'outils d'information, de bases de données, de systèmes SIG et diffusion des études et expertises en urbanisme.</p>
                        <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Coopération dans le Domaine de l'Urbanisme</h3>
                        <p class="mb-4">Renforcement des partenariats nationaux et internationaux à travers la coopération, les conventions et la participation aux événements spécialisés..</p>
                        <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>En savoir plus</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item d-flex position-relative text-center h-100">
                    ...
                    <div class="service-text p-5">
                        ...
                        <h3 class="mb-3">Encadrement de la Filière Urbanisme</h3>
                        <p class="mb-4">Valorisation des compétences nationales en urbanisme par la formation et l'accompagnement des structures du secteur.</p>
                        <a class="btn" href=""><i class="fa fa-plus text-primary me-3"></i>En savoir plus</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-4">
                                <h3>Expertise Publique Certifiée</h3>
                                <p class="mb-0">Pôle national de compétence en urbanisme, l'ANURB intervient conformément à la législation et à la réglementation en vigueur.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-4">
                                <h3>Approche Technique & Intégrée</h3>
                                <p class="mb-0">Une méthodologie rigoureuse basée sur l'étude, la planification, la réglementation et l'analyse territoriale.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="ms-4">
                                <h3>Maîtrise des Projets Urbains</h3>
                                <p class="mb-0">Accompagnement complet des projets publics, de la conception à la mise en œuvre, au service de l'État et des collectivités locales.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-xxl project py-5">
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <h4 class="section-title">Travaux ANURB</h4>
...
Réhabilitation et intervention sur le tissu urbain ancien</h3>
                    ...
                    <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-4" data-bs-toggle="pill" data-bs-target="#tab-pane-3" type="button">
                        <h3 class="m-0">03. Le pôle urbain d'Oran</h3>
                    </button>
                    <button class="nav-link w-100 d-flex align-items-center text-start p-4 mb-0" data-bs-toggle="pill" data-bs-target="#tab-pane-4" type="button">
                        <h3 class="m-0">04. SIG villes nouvelles</h3>
                    </button>
                </div>
            </div>
            <div class="col-lg-8">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6" style="min-height: 350px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute img-fluid w-100 h-100" src="assets/images/projet01.png"
    ...
    <div class="container">
        <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            ...
            <h1 class="display-5 mb-4">
                Si vous avez des questions, n'hésitez pas à nous contacter.</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-flex flex-column justify-content-between h-100">
                    <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                        ...
                        <div class="ms-4">
                            ...
                            <h3 class="mb-0">Tribu Bouzid,Route de Draria, El Achour, Alger</h3>
                        </div>
                    </div>
                    <div class="bg-light d-flex align-items-center w-100 p-4 mb-4">
                        <div class="d-flex flex-shrink-0 align-items-center justify-content-center bg-dark" style="width: 55px; height: 55px;">
                        ...
                        <div class="ms-4">
                            <p class="mb-2">Téléphone / Fax</p>
                            <h3 class="mb-0">023 35 14 07 / 021 33 15 45</h3>
                        </div>
                    </div>
                    <div class="bg-light d-flex align-items-center w-100 p-4">
                        ...
                        <div class="ms-4">
                            ...
                            <h3 class="mb-0">contact@anurb.dz/ anurb.dz@gmail.com</h3>
                        </div>
                    </div>
                </div>
            </div>
